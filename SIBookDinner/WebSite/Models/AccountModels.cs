...
namespace WebSite.Models
{
    ...
    public interface IMembershipService
    {
        ...
        bool ValidateUser(string StaffName, string StaffPwd);
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        //public bool ValidateUser(string StaffNo, string StaffPwd)
        public bool ValidateUser(string StaffName, string StaffPwd)
        {
            if (String.IsNullOrEmpty(StaffName)) throw new ArgumentException("值不能为 null 或为空。", "StaffNo");
            if (String.IsNullOrEmpty(StaffPwd)) throw new ArgumentException("值不能为 null 或为空。", "StaffPwd");

            if (LoginManager.Login(StaffName, StaffPwd))
            {
                return true;
            }
            return false;
        ...
        //        newPassword = SIStudio.Framework.SISecurity.MD5(newPassword);
        //        oldPassword = SIStudio.Framework.SISecurity.MD5(oldPassword);
    ...
    {
        void SignIn(string StaffName, bool createPersistentCookie);
        void SignOut();
    }

    public class FormsAuthenticationService : IFormsAuthenticationService
    {
        public void SignIn(string StaffName, bool createPersistentCookie)
        {
            if (String.IsNullOrEmpty(StaffName)) throw new ArgumentException("值不能为 null 或为空。", "StaffNo");

            //FormsAuthentication.SetAuthCookie(StaffNo, createPersistentCookie);
        }
